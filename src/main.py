...
from eda_ja.eda import Eda, EdaJa, EdaEn
...
def main():
    ...
    parser.add_argument("--input", default="input.txt", help="input file of unaugmented data")
    parser.add_argument("--output", default="output.txt", help="output file of augmented data")
    ...
    with open(args.output, 'w') as writer:
        for i, line in enumerate(lines):
            aug_sentences = instance.generate_sentences(line, alpha_sr=args.alpha_sr, alpha_ri=args.alpha_ri, alpha_rs=args.alpha_rs, p_rd=args.alpha_rd, num_aug=args.num_aug)
